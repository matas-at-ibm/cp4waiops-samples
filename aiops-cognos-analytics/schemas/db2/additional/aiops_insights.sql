...
CALL SYSPROC.ADMIN_CMD('REORG TABLE INCIDENTS_REPORTER_STATUS')@
...
CALL SYSPROC.ADMIN_CMD('REORG TABLE ALERTS_REPORTER_STATUS')@
...
CREATE TABLE RESOURCE_GROUP_TAGS  (
	...
	TAG VARCHAR(255),
	FOREIGN KEY (RESOURCEGROUPUUID) REFERENCES RESOURCE_GROUPS(UUID) ON DELETE CASCADE
)@
--DATA CAPTURE NONE@
...
CREATE TABLE INCIDENTS_ALERTS_RELATIONS (
	...
	ALERTUUID VARCHAR(255) NOT NULL,
	FOREIGN KEY (INCIDENTUUID) REFERENCES INCIDENTS_REPORTER_STATUS(UUID) ON DELETE CASCADE
)@
--DATA CAPTURE NONE@
...
WHERE
	(
    	...
    	CREATEDTIME - CURRENT_TIMEZONE < ADD_DAYS( CURRENT_TIMESTAMP - CURRENT_TIMEZONE, -1)
    	AND (LASTCHANGEDTIME - CURRENT_TIMEZONE > ADD_DAYS( CURRENT_TIMESTAMP - CURRENT_TIMEZONE, -1) OR (STATE <> 'closed' AND STATE <> 'resolved'))
    )
),
...
WHERE
	(
    	...
    	CREATEDTIME - CURRENT_TIMEZONE < ADD_DAYS( CURRENT_TIMESTAMP - CURRENT_TIMEZONE, -30)
    	AND (LASTCHANGEDTIME - CURRENT_TIMEZONE > ADD_DAYS( CURRENT_TIMESTAMP - CURRENT_TIMEZONE, -30 ) OR (STATE <> 'closed' AND STATE <> 'resolved'))
    )
),
INCIDENTS_BY_RESOURCE_GROUPS AS (
	SELECT
...
WHERE
	(
    	...
    	CREATEDTIME - CURRENT_TIMEZONE < ADD_DAYS( CURRENT_TIMESTAMP - CURRENT_TIMEZONE, -7)
    	AND (LASTCHANGEDTIME - CURRENT_TIMEZONE > ADD_DAYS( CURRENT_TIMESTAMP - CURRENT_TIMEZONE, -7) OR (STATE <> 'closed' AND STATE <> 'resolved'))
    )
),
INCIDENTS_BY_RESOURCE_GROUPS AS (
	SELECT
...
INSERT INTO MQT_REFRESH_TIME (REFRESHTIME) VALUES (CURRENT_TIMESTAMP)@
...
BEGIN
  ...
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_ACTIVTY_BY_PRIORITY_LAST_24_HOURS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;

  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_ACTIVTY_BY_TIME_LAST_24_HOURS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
  
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_HANDLING_METRICS_LAST_24_HOURS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
    
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE NOISE_REDUCTION_LAST_24_HOURS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;

  -- Refresh last 7 days MQTs
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_ACTIVTY_BY_PRIORITY_LAST_7_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;

  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_ACTIVTY_BY_TIME_LAST_7_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
  
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_HANDLING_METRICS_LAST_7_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
    
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE NOISE_REDUCTION_LAST_7_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
  
  -- Refresh last 30 days MQTs
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_ACTIVTY_BY_PRIORITY_LAST_30_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;

  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_ACTIVTY_BY_TIME_LAST_30_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
  
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE INCIDENT_HANDLING_METRICS_LAST_30_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;
    
  SET REFRESH_MQT_STATEMENT = 'REFRESH TABLE NOISE_REDUCTION_LAST_30_DAYS';
  EXECUTE IMMEDIATE REFRESH_MQT_STATEMENT;

  UPDATE MQT_REFRESH_TIME
